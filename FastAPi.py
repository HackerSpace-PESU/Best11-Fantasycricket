...
def result(request : Request):
	...
	return templates.TemplateResponse("result.html",context = {'request':request,
															   'c1':c[0],'v1':v[0],'t1':players[0],
															   'c2':c[1],'v2':v[1],'t2':players[1],
        													   'c3':c[2],'v3':v[2],'t3':players[2],
        													   'c4':c[3],'v4':v[3],'t4':players[3],
														       'c5':c[4],'v5':v[4],'t5':players[4],
														       'c6':c[5],'v6':v[5],'t6':players[5],
														       'c7':c[6],'v7':v[6],'t7':players[6],
														       'c8':c[7],'v8':v[7],'t8':players[7],
														       'c9':c[8],'v9':v[8],'t9':players[8],
														       'c10':c[9],'v10':v[9],'t10':players[9],
														       'c11':c[10],'v11':v[10],'t11':players[10]})